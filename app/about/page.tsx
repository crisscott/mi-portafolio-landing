    ...
    return (
        <section className="space-y-8">
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-8 border-l border-zinc-200 dark:border-zinc-800 pl-6">
                    <div className="relative">
                        <span className="absolute -left-3 top-1.5 h-3 w-3 rounded-full bg-blue-600 dark:bg-blue-400" />
                        ...
                        <ul className="list-disc pl-5 mt-2 space-y-1 text-gray-700 dark:text-gray-300">
                            <li>
                                Integración de APIs de delivery (DiDi, Rappi,
                                Uber Eats) con el sistema POS mediante Java EE,
                                Webhooks y RMI.
                            </li>
                            <li>
                                Reducción del tiempo de procesamiento de pedidos
                                de 90s a 10s y cero downtime en los últimos 6
                                meses.
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="relative">
                        ...
                        <ul className="list-disc pl-5 mt-2 space-y-1 text-gray-700 dark:text-gray-300">
                            <li>
                                Desarrollo de un CRM integral con Laravel y
                                MySQL para centralizar datos contables y de
                                nómina.
                            </li>
                            <li>
